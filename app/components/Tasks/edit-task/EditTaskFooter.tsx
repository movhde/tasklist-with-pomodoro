  ...
  return (
    <div className="flex items-center justify-between border-t border-black/5 pt-5">
      <div className="flex gap-2 sm:gap-3">
        <button
          onClick={onDelete}
          className="cursor-pointer flex items-center gap-1 sm:gap-2 font-sniglet rounded-[16px] sm:rounded-[20px] bg-red-50 px-3 py-2 sm:px-5 sm:py-3 text-red-500 transition-all duration-200 hover:bg-red-100"
        >
        ...
        {onCancel && (
          <button
            onClick={onCancel}
            className="cursor-pointer flex items-center  gap-1 sm:gap-2 rounded-[16px] sm:rounded-[20px] border border-black/5 bg-[#F4F7FB] px-3 py-2 sm:px-6 sm:py-3
      ...
      <button
        ...
        bg-[#FD81B0] py-2 sm:px-8 sm:py-3 font-semibold tracking-wide
