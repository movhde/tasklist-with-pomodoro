...
export default function CalendarPicker({ value, onChange }: Props) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute top-full left-1/2 z-50 mt-4 w-[80vw] max-w-[350px] -translate-x-1/2 rounded-[36px] border border-white/5 bg-black/40 p-4 backdrop-blur-sm sm:p-5 md:left-0 md:w-[350px] md:translate-x-0 md:p-7">
          <DayPicker
            mode="single"
            selected={selected}
